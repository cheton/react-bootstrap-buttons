...
```jsx
<ButtonGroup btnSize="lg" btnStyle="secondary">
    <Button>Left</Button>
    <Button>Middle</Button>
    <Button>Right</Button>
</ButtonGroup>
...
```jsx
<ButtonGroup btnSize="md" btnStyle="secondary">
    <Button>Left</Button>
    <Button>Middle</Button>
    <Button>Right</Button>
</ButtonGroup>
...
```jsx
<ButtonGroup btnSize="sm" btnStyle="secondary">
    <Button>Left</Button>
    <Button>Middle</Button>
    <Button>Right</Button>
</ButtonGroup>
...
```jsx
<ButtonGroup btnSize="xs" btnStyle="secondary">
    <Button>Left</Button>
    <Button>Middle</Button>
    <Button>Right</Button>
</ButtonGroup>
